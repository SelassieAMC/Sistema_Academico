    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="home" class="logo">
          ...
          <span class="logo-mini">Estudiante</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">Estudiante</span>
        </a>
            ...
            <li class="active treeview">
              ...
              <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('HorarioE') }}{{ Auth::user()->id }}"><i class="fa fa-calendar"></i>Horario</a></li>
                  <li class="active"><a href="{{ url('SalonDirector') }}{{ Auth::user()->id }}"><i class="fa fa-map-marker"></i>Salon y director</a></li>
                </ul>
              </li>
              ...
              <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('NotasP') }}{{ Auth::user()->id }}"><i class="fa fa-check-square-o"></i>Notas parciales</a></li>
                  <li class="active"><a href="{{ url('VerificarBoletin') }}{{ Auth::user()->id }}"><i class="fa fa-file-pdf-o"></i>Boletines</a></li>
                </ul>
              </li>

              <li class="treeview">
              <a href="#">
                <i class="fa fa-calendar-check-o"></i> <span>Historial Academico</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('HistorialA') }}{{ Auth::user()->id }}"><i class="fa fa-check-square-o"></i>Notas</a></li>
                </ul>
              </li>
              ...
              <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('CorreosInstitucionales') }}"><i class="fa fa-at"></i>Correos Institucionales</a></li>
                </ul>
              </li>
              ...
              <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('Historia') }}"><i class="fa fa-puzzle-piece"></i>Historia</a></li>
                  <li class="active"><a href="{{ url('Valores') }}"><i class="fa fa-gavel"></i>Valores institucionales</a></li>
                  <li class="active"><a href="{{ url('Himno') }}"><i class="fa fa-street-view"></i>Himno</a></li>
                </ul>
              </li>
