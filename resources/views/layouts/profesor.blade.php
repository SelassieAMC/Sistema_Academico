    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="home" class="logo">
          ...
          <span class="logo-mini">Profesor</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">Profesor</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="{{ url('HorarioClase') }}{{ Auth::user()->id }}" ><i class="fa fa-calendar"></i>Horario de clases</a></li>
                <li class="active"><a href="{{ url('SalonDicta') }}{{ Auth::user()->id }}" ><i class="fa fa-map-marker"></i>Salones donde dicta clase</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="{{ url('Cursos') }}{{ Auth::user()->id }}" ><i class="fa fa-check-square-o"></i>Cursos</a></li>
              </ul>
            </li>
            <li class="treeview">
             <a href="#">
             ...
             <ul class="treeview-menu">
               <li class="active"><a href="{{ url('CorreosInstitu')}}" ><i class="fa fa-at"></i>Correos Institucionales</a></li>
             </ul>
           </li>
           <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="{{ url('HistoriaP') }}"><i class="fa fa-puzzle-piece"></i>Historia</a></li>
              <li class="active"><a href="{{ url('ValoresP') }}"><i class="fa fa-gavel"></i>Valores institucionales</a></li>
              <li class="active"><a href="{{ url('HimnoP') }}"><i class="fa fa-street-view"></i>Himno</a></li>
            </ul>
          </li>
          </ul>
        </section>
