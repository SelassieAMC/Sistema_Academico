            ...
            <li class="header">MENÚ</li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="asignaHorariosProf"><i class="fa fa-tag"></i>Horario de Clases</a></li>
                  </ul>
              </li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="asignaCursoEstu"><i class="fa fa-refresh"></i>Actualizacion de datos</a></li>
                    <li class="active"><a href="cargarDesdeArchivo"><i class="fa fa-upload"></i>Actualizacion desde archivo</a></li>
                  </ul>
              </li>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-newspaper-o"></i> <span>Publicaciones</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a  href="{{ url('publicar') }}{{ Auth::user()->id }}"> <i class="fa fa-share-alt"></i>Crear publicacion</a></li>

                  <li class="active"><a href="listar_pubs"><i class="fa fa-edit"></i>Historial y edicion</a></li>
                </ul>
              </li>

              <li class="treeview">
              <a href="#">
                <i class="fa fa-camera"></i> <span>Galeria</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li class="active"><a href="{{ url('Galeria') }}{{ Auth::user()->id }}"><i class="fa fa-plus"></i>Agregar</a></li>
                  <li class="active"><a href="listar_fotos"><i class="fa fa-folder-open-o"></i>Listar y Eliminar</a></li>
              </ul>
            </li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="form_enviar_correo" ><i class="fa fa-send"></i>Redactar</a></li>
                <li class="active"><a href="infoPadres" ><i class="fa fa-send"></i>Acudientes</a></li>
                <li class="active"><a href="CorreosInstituA" ><i class="fa fa-send"></i>Institucionales</a></li>
              </ul>
            </li>

              <li class="active treeview">
                <a href="#">
                 <span >Creacion y administracion de <br>Objetos</span>
                </a>
              </li>
              ...
              <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="form_cargar_datos_usuarios"><i class="fa fa-file-excel-o"></i>Cargar usuarios</a></li>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="materias"><i class="fa fa-plus-square"></i>Agregar</a></li>
                        <li class="active"><a href="listaMaterias" ><i class="fa fa-pencil"></i>Editar y eliminar materias</a></li>
                        <li class="active"><a href="listaProfesoresAsignados" ><i class="fa fa-eye"></i>Ver profesores asignados</a></li>
                    </ul>
                  </li>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li class="active"><a href="curso"><i class="fa fa-plus-square"></i>Agregar</a></li>
                      <li class="active"><a href="listaCursos"><i class="fa fa-list-alt"></i>Listar y editar</a></li>
                      <li class="active"><a href="horariosMatxCurso" ><i class="fa fa-calendar"></i>Asignar Materias y horarios</a></li>
                      <li class="active"><a href="consultHorarios" ><i class="fa fa-eye"></i>Ver Horarios y Materias</a></li>
                    </ul>
                  </li>
                  ...
                  <a href="#">
                    ...
                    <ul class="treeview-menu">
                      <li class="active"><a href="nuevaAula"><i class="fa fa-plus-square"></i>Agregar</a></li>
                      <li class="active"><a href="listaAulas"><i class="fa fa-list-alt"></i>Listar y editar</a></li>
                      <li class="active"><a href="asignaCurso"><i class="fa fa-exchange"></i>Asignar Cursos</a></li>
                      <li class="active"><a href="consultaAsignaciones"><i class="fa fa-eye"></i>Ver Asignaciones</a></li>
                    </ul>
                  </li>
          </ul>
        </section>
