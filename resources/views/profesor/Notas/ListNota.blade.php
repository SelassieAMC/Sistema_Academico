            ...
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tbody >
                  ...
                  <td ><input onclick=this.form.action='ActualizarPorce' type='submit' class='btn btn-primary' value='Actualizar %'/></td>
                </tbody>
              </table>
            <table class="table table-hover">
                <thead >
                ...
                <tbody >
                    ...
                    <td >{{$Nota->definitiva}}</td>
                     <td ><input onclick=this.form.action='ActualizarNotas?num=<?= $num; ?>' type='submit' name="" class='btn btn-primary' value='Actualizar'/></td>

                    <td ><input onclick=this.form.action="Bimestre1?num=<?= $num; ?>" type="submit" class="btn btn-primary" value="Bim1"/></td>
                    <td ><input onclick=this.form.action="Bimestre2?num=<?= $num; ?>" type="submit" class="btn btn-primary" value="Bim2"/></td>
                    <td ><input onclick=this.form.action="Bimestre3?num=<?= $num; ?>" type="submit" class="btn btn-primary" value="Bim3"/></td>
                    <td ><input onclick=this.form.action="Bimestre4?num=<?= $num; ?>" type="submit" class="btn btn-primary" value="Bim4"/></td>
                    <td ><input onclick=this.form.action="Definitiva?num=<?= $num; ?>" type="submit" class="btn btn-primary" value="Def"/></td>
                </tbody>
                @endforeach
            </table>
          </div>
