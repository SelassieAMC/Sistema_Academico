                ...
                <div class="navigation-right">
                    ...
                    <nav class="link-effect-3" id="link-effect-3">
                        <ul class="nav1 nav nav-wil">
                            ...
                            <li class="active"><a data-hover="Noticias" href="{{ url('noticias?setFocus=true') }}">Noticias</a></li>
...
@if($publicacion->seccion=='Noticias')
<div class="table-responsive">
   <div class="tabla_relleno">
      <br />
      <p class="TitulosP">{!! $publicacion->titulo !!}</p>
      <br />
      <div class="Imagee">
      {!! Html::image($publicacion->pathImagen,'', array( 'width' => '100%', 'height' => 'auto' )) !!}
      </div>
      <br /><br />
      <div class="Descripcion">{!! $publicacion->descripcion !!}</div><br /><br />
      <button type="button" class="btn btn-danger btn-lg btn-block active">{!! Html::link($publicacion->pathPDF,'Leer mas...', ['target'=>'_blank']) !!}</button>
