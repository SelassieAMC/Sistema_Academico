  ...
  //Funcion para direccionar al formulario de creacion
    ...
    public function TablaNotas(){
      ...
      $grad=$_GET['grad'];
        ...
        return view ('profesor.Notas.ListNota', compact('Notas','id','mate','grad'));
    }
    ...
    public function Historia(){
      return View('profesor.Servicios.Historia');
    }



    public function ValoresInst(){
      return View('profesor.Servicios.Valores');
    }

    public function Himno(){
      return View('profesor.Servicios.Himno');
    }
