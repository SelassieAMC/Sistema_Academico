...
<div class="form-group col-xs-6">
                      ...
                      <input type="text" class="form-control" id="name" readonly="readonly" name="name"  value="<?= $usuario->name; ?>"  >
</div>
<div class="form-group col-xs-6">
                      <label for="last_name">Apellidos</label>
                      <input type="text" class="form-control" id="last_name" readonly="readonly" name="last_name" value="<?= $usuario->last_name; ?>" >
</div>
...
<div class="form-group col-xs-12">
                      ...
                      <input type="text" class="form-control" id="direccion" readonly="readonly" name="direccion" value="<?= $usuario->direccion; ?>" >
</div>
