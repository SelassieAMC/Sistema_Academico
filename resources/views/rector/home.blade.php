      ...
      <div class="panel-body">
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-gray">
            ...
            <a href="javascript:void(0);" onclick="cargarlistado(2,2);" class="small-box-footer">Mas informacion<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="verEstados" class="small-box-footer">Mas informacion<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Directores de curso</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-person"></i>
            </div>
            <a href="CorreosInstituR" class="small-box-footer">Mas informacion<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>     
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="verHorarios" class="small-box-footer">Mas informacion<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
    </div>
